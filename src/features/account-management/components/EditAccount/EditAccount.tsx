...
export function EditAccount() {
      ...
      <div className="edit-account__inner">
        ...
        <div className="edit-account__box">
          ...
          <Input
            data-cy="first-name"
            validationMessages={[
              `This first name is required. Please fill it up.`,
            ]}
            value={account.firstName}
            isInvalid={!account.firstName && triedToSubmit}
            onChange={(event: ChangeEvent<HTMLInputElement>) => setAccount({
              ...account,
        ...
        <div className="edit-account__box">
          ...
          <Input
            data-cy="last-name"
            validationMessages={[
              `This last name is required. Please fill it up.`,
            ]}
  ...
  async function getEditAccountLoad() {
    ...
    setRolesData(Object.assign({}, ...roles.map((role) => ({
      [role.id]: role.name, 
    }))))
  }
